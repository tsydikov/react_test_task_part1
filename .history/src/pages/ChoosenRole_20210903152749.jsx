    ...
    <>
      <Form>
        ...
        <div className={cl.twoButtons}>
          <Button onClick={() => router.push('/terms')} ><ReactSVG src={borrower} />Go To Cabinet</Button>
          <ButtonCancel onClick={() => router.push('/')}><ReactSVG src={close} />
            Cancel</ButtonCancel>
        </div>
      </Form>
      <FormInv>
      <div className={cl.BtnAndSpan}>
      <ButtonCancel onClick={() => router.push('/terms')}><ReactSVG src={guide} /><pre>Guide Flow</pre></ButtonCancel>
      <span>
